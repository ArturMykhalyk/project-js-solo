import{a as d,i as u,S as E,N as S,P as T,A as P}from"./assets/vendor-D3YsHSez.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=n(t);fetch(t.href,o)}})();async function y({currentPage:e=1,name:a="",sortName:n="",genre:i=""}={}){try{const r="https://sound-wave.b.goit.study/api"+"/artists",c={limit:8,page:e,...a&&{name:a},...n&&{sortName:n},...i&&{genre:i}};return(await d.get(r,{params:c})).data}catch(t){return u.error({message:`${t}`,position:"topRight"}),null}}async function q(e="65ada227af9f6d155db46908"){try{const a="https://sound-wave.b.goit.study/api",n=`/artists/${e}`,i=a+n;return(await d.get(i)).data}catch(a){return u.error({message:`${a}`,position:"topRight"}),null}}async function O(e="65ada227af9f6d155db46908"){try{const a="https://sound-wave.b.goit.study/api",n=`/artists/${e}/albums`,i=a+n;return(await d.get(i)).data}catch(a){return u.error({message:`${a}`,position:"topRight"}),null}}async function C(){try{const n="https://sound-wave.b.goit.study/api"+"/feedbacks",i={limit:12};return(await d.get(n,{params:i})).data}catch(e){return u.error({message:`${e}`,position:"topRight"}),null}}let L=0;function R(e){L=e}function M(){return L}const s={mobileMenuOpen:document.getElementById("open-menu"),mobileMenuClose:document.getElementById("close-btn"),mobileMenuList:document.querySelector(".header-menu"),artistsList:document.querySelector(".artists-list"),loader:document.querySelector(".loader"),modalLoader:document.querySelector(".modal-loader"),moreBtn:document.querySelector(".moreButton"),feedBack:document.querySelector(".swiper-wrapper"),modal:document.querySelector(".modal"),closeModalBtn:document.querySelector(".modal__close-btn"),modalArtistBiography:document.querySelector(".modal-biography"),modalArtisTAlbums:document.querySelector(".modal-albums")};function j(){s.modal.classList.add("modal--is-open"),document.body.style.overflow="hidden",document.addEventListener("keydown",k),window.addEventListener("click",$),s.closeModalBtn.addEventListener("click",m)}function m(){document.body.style.overflow="",s.modal.classList.remove("modal--is-open"),document.removeEventListener("keydown",k),window.removeEventListener("click",$)}function k(e){e.key==="Escape"&&m()}function $(e){e.target===s.modal&&m()}const l="/project-js-solo/assets/sprite-oGdn5a-q.svg";function w(e){return e.map(({_id:a,strArtist:n,strArtistThumb:i,strBiographyEN:t,genres:o})=>`<li class="artists--list__item">
        <img
          class="artists--photo"
          src="${i}"
          alt="${n}"
  ...
  `).join("")}function H(e){s.artistsList.innerHTML=w(e)}function N(e){s.artistsList.insertAdjacentHTML("beforeend",w(e))}function p(e){e.classList.add("visible")}function f(e){e.classList.remove("visible")}function _(){s.moreBtn.classList.add("visible")}function b(){s.moreBtn.classList.remove("visible")}function U(e){const a=e.map(({_id:t,name:o,rating:r,descr:c})=>`<div class="swiper-slide" data-id="${t}">
...
<p class='feed-back--name'>${o}</p>
...
</div>`).join("");s.feedBack.innerHTML=a,new E(".modal-product__slider",{modules:[S,T,P],navigation:{nextEl:".custom-next",prevEl:".custom-prev"},pagination:{el:".swiper-pagination",clickable:!1,type:"custom"},autoplay:{delay:5e3},on:{init(){n(this.realIndex,this.slides.length),i(this)},slideChange(){n(this.realIndex,this.slides.length)}}});function n(t,o){const r=document.querySelectorAll(".swiper-pagination .bullet");r.forEach(c=>c.classList.remove("swiper-pagination-bullet-active")),t===0?r[0].classList.add("swiper-pagination-bullet-active"):t===o-1?r[2].classList.add("swiper-pagination-bullet-active"):r[1].classList.add("swiper-pagination-bullet-active")}function i(t){var o,r,c;(o=document.querySelector(".bullet.left"))==null||o.addEventListener("click",()=>{t.slideTo(0)}),(r=document.querySelector(".bullet.center"))==null||r.addEventListener("click",()=>{t.slideTo(Math.floor(t.slides.length/2))}),(c=document.querySelector(".bullet.right"))==null||c.addEventListener("click",()=>{t.slideTo(t.slides.length-1)})}}function x({intDiedYear:e,intFormedYear:a,intMembers:n,strGender:i,strArtist:t,strArtistThumb:o,strBiographyEN:r,strCountry:c},v){const B=`
   ...
   <img class="modal-biography__photo" src="${o}" alt="${t}" />
        ...
        <p class="modal-biography___years">Years active</br> <span>${a}-${e??"present"}</span></p>
        ...
        </div></div>`;s.modalArtistBiography.innerHTML=B}function I(e){s.modalArtisTAlbums.innerHTML=e.map(a=>F(a)).join("")}function F(e){const a=e.tracks.map(i=>{const t=Math.floor(i.intDuration/6e4),o=Math.floor(i.intDuration%6e4/1e3).toString().padStart(2,"0");return`
  ...
  `}let h=1;async function D(){if(M()>h){p(s.loader),b();const e=await y({currentPage:++h});f(s.loader),_(),N(e.artists)}else b()}async function z(e){if(e.target.className!=="artist--btn")return;s.modalArtisTAlbums.innerHTML="",s.modalArtistBiography.innerHTML="",j();const a=e.target.parentElement.children[1].innerHTML,n=e.target.dataset.id;p(s.modalLoader);const i=await q(n),t=await O(n);f(s.modalLoader),x(i,a),I(t.albumsList)}function G(){s.mobileMenuClose.classList.remove("hidden"),s.mobileMenuOpen.classList.add("hidden"),s.mobileMenuList.classList.add("open"),s.mobileMenuClose.addEventListener("click",g),s.mobileMenuList.addEventListener("click",A),document.body.style.overflow="hidden"}function A(e){e.target.nodeName==="A"&&g()}function g(){document.body.style.overflow="",s.mobileMenuClose.classList.add("hidden"),s.mobileMenuOpen.classList.remove("hidden"),s.mobileMenuList.classList.remove("open"),s.mobileMenuClose.removeEventListener("click",g),s.mobileMenuList.removeEventListener("click",A)}s.mobileMenuOpen.addEventListener("click",G);s.artistsList.addEventListener("click",z);async function K(){p(s.loader);const e=await y();f(s.loader),H(e.artists),R(e.totalArtists/8),M()>1&&(_(),s.moreBtn.addEventListener("click",D));const a=await C();U(a.data)}K();
