...
<p class='feed-back--name'>${a}</p>
   ...
   <img class="modal-biography__photo" src="${a}" alt="${o}" />
        ...
        <ul class="modal-biography__genre-list">${w}</ul>
